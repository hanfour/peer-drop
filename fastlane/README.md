...
The `SnapshotTests` class captures 10 screenshots:
...
Screenshots are saved to `fastlane/screenshots/` organized by:
- Language: `en-US/`, `zh-Hant/`
- Device: `iPhone 17 Pro Max-*.png`, `iPhone 17 Pro-*.png`
