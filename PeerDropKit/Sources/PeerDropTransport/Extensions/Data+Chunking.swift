...
extension Data {
    ...
    public func chunks(ofSize size: Int) -> [Data] {
...
public struct FileChunkIterator: Sequence, IteratorProtocol {
    private let handle: FileHandle
    private let chunkSize: Int
    private let totalSize: Int64
    private var bytesRead: Int64 = 0

    public init(handle: FileHandle, chunkSize: Int = Data.defaultChunkSize, totalSize: Int64) {
        self.handle = handle
