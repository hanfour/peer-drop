...
public final class BLEDiscovery: NSObject, DiscoveryBackend {

    public let source: DiscoverySource = .bluetooth
    ...
    public init(localPeerID: String, localDisplayName: String) {
