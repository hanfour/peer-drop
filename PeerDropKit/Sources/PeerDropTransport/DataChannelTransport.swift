...
public final class DataChannelTransport: TransportProtocol {
    ...
    public enum ReassemblyRejectReason: String {
    ...
    public var onReassemblyRejected: ((ReassemblyRejectReason) -> Void)?

    /// Test-only accessor for the current buffer state.
    public var reassemblyBufferCount: Int {
    ...
    public var onAssembledDataForTesting: ((Data) -> Void)?

    // MARK: - Properties

    public let client: DataChannelClient
    ...
    public init(client: DataChannelClient) {
        self.client = client
