...
public final class PeerDropFramer: NWProtocolFramerImplementation {
    public static let label = "PeerDrop"
...
extension NWParameters {
    public static func peerDrop(tls: NWProtocolTLS.Options? = nil) -> NWParameters {
