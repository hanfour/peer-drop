...
@MainActor
public final class FileTransferSession: ObservableObject {
    ...
    public func handleFileComplete(_ message: PeerMessage) -> TransferRecord? {
    ...
    public func canResume(metadata: TransferMetadata) -> Bool {
    ...
    public func handleResumeRequest(_ payload: FileResumePayload, peer: MessageSendingPeer, senderID: String) {
    ...
    public func handleResumeAck(_ payload: FileResumeAckPayload) {
        if payload.accepted {
    ...
    public func sendFileWithResume(at url: URL, resumeOffset: Int64, isDirectory: Bool = false) async throws {
    ...
    public func clearInterruptedTransfer() {
