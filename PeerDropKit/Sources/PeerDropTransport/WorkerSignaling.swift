...
public protocol WorkerSignalingProtocol: AnyObject {
...
public final class WorkerSignaling: NSObject, WorkerSignalingProtocol {
    ...
    public var onSDPOffer: ((String) -> Void)?
    public var onSDPAnswer: ((String) -> Void)?
    public var onICECandidate: ((String, String?, Int32) -> Void)? // sdp, sdpMid, sdpMLineIndex
    ...
    public struct RoomInfo {
        ...
        public init(roomCode: String, roomToken: String?) {
    ...
    public func createRoom() async throws -> RoomInfo {
    ...
    public func joinRoom(code: String, token: String? = nil, retryCount: Int = 0) {
    ...
    public struct ICEResult {
        public let credentials: ICECredentials?
        public let roomToken: String?

        public init(credentials: ICECredentials?, roomToken: String?) {
    ...
    public func requestICECredentials(roomCode: String) async throws -> ICEResult {
    ...
    public func sendSDP(_ sdp: String, type: String) {
    ...
    public func sendICECandidate(sdp: String, sdpMid: String?, sdpMLineIndex: Int32) {
        let message: [String: Any] = [
            "type": "ice-candidate",
            "candidate": sdp,
            "sdpMid": sdpMid ?? "",
...
public enum WorkerSignalingError: LocalizedError {
