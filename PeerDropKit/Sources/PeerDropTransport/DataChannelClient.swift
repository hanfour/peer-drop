...
public final class DataChannelClient: NSObject {
    ...
    public var onDataChannelOpen: (() -> Void)?
    public var onDataChannelClose: (() -> Void)?
    public var onDataReceived: ((Data) -> Void)?
    public var onRemoteDataChannel: ((RTCDataChannel) -> Void)?
    ...
    public func setup(with configuration: RTCConfiguration) {
    ...
    public func createDataChannel() -> RTCDataChannel? {
    ...
    public var localDTLSFingerprint: String? {
...
public enum DataChannelError: LocalizedError {
    case notInitialized
    case noSDP
