...
@MainActor
public final class ConnectionContext: ObservableObject {
    @Published public private(set) var hasTailscale: Bool = false
    @Published public private(set) var tailnetPeerCount: Int = 0
    @Published public private(set) var lastRelayFailure: Date?
    @Published public private(set) var recentFailureRate: Double = 0
    @Published public private(set) var knownDeviceSample: DeviceRecord?

    public init() {}

    public var primaryRecommendation: ConnectionRecommendation {
    ...
    public func setKnownDeviceSample(_ rec: DeviceRecord?) { knownDeviceSample = rec }
    public func setTailscaleState(hasTailscale: Bool, tailnetPeerCount: Int) {
        self.hasTailscale = hasTailscale; self.tailnetPeerCount = tailnetPeerCount
    }
    public func setRecentFailureRate(_ rate: Double) { recentFailureRate = rate }

    // MARK: - Live Signal Wiring

    public func observe(deviceStore: DeviceRecordStore, tailnetStore: TailnetPeerStore) {
...
public enum ConnectionRecommendation: Equatable {
