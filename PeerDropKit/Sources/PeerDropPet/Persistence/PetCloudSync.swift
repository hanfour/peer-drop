...
public class PetCloudSync {
    ...
    public func syncMetadata(_ pet: PetState) {
    ...
    public func syncFullState(_ pet: PetState) throws {
    ...
    /// conflict resolution.
    public func loadFromCloud() throws -> PetState? {
        guard let dir = cloudDirectory else {
    ...
    public func observeCloudChanges(onUpdate: @escaping (PetState) -> Void) {
