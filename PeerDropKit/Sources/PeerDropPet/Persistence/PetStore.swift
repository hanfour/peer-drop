...
public class PetStore {
    ...
    public func saveEvolutionSnapshot(_ pet: PetState) throws {
    ...
    public func loadSnapshots() throws -> [PetState] {
    ...
    public func loadAndMigrate(defaults: UserDefaults = .standard) throws -> PetState? {
        guard FileManager.default.fileExists(atPath: petFile.path) else {
            return nil
        }
        let data = try Data(contentsOf: petFile)
    ...
    ///   • migrationDoneAt ← now()
    public static func applyV4Migration(to pet: PetState) -> PetState {
    ...
    public static func deterministicSeed(petID: UUID, petName: String?) -> UInt32 {
