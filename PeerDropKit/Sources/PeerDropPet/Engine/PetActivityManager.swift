...
@available(iOS 16.2, *)
@MainActor
public class PetActivityManager {
    private var currentActivity: Activity<PetActivityAttributes>?

    public init() {}

    public static func contentState(from snapshot: PetSnapshot) -> PetActivityAttributes.ContentState {
    ...
    public func startActivity(snapshot: PetSnapshot) {
    ...
    public func updateActivity(snapshot: PetSnapshot) {
