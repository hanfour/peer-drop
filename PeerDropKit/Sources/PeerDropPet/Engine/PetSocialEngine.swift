...
public struct PetGreeting: Codable {
...
extension PetGreeting {
    ...
    public var effectiveProtocolVersion: Int { protocolVersion ?? 1 }
    ...
    public func downgraded(toProtocolVersion targetVersion: Int) -> PetGreeting {
...
public final class PetSocialEngine {
    ...
    public func onPetMeeting(myPet: PetState, partnerGreeting: PetGreeting) -> SocialEntry {
    ...
    public func tryReveal(pet: PetState) -> SocialEntry? {
