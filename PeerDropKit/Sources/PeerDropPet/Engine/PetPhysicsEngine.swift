...
public enum PetPhysicsEngine {

    public static let gravity: CGFloat = 800
    public static let bounceRestitution: CGFloat = 0.3
    public static let throwDecay: CGFloat = 0.95
    public static let petSize: CGFloat = 16

    // MARK: - Core Physics

    public static func update(_ state: inout PetPhysicsState, dt: CGFloat, surfaces: ScreenSurfaces,
    ...
    public static func resolveCollision(_ state: inout PetPhysicsState, surfaces: ScreenSurfaces,
    ...
    public static func applyWalk(_ state: inout PetPhysicsState, direction: HorizontalDirection,
    ...
    public static func applyClimb(_ state: inout PetPhysicsState, speed: CGFloat,
    ...
    public static func applyJump(_ state: inout PetPhysicsState, jumpVelocity: CGFloat = -300) {
        state.velocity.dy = jumpVelocity
        state.surface = .airborne
    }

    public static func applyThrow(_ state: inout PetPhysicsState, velocity: CGVector) {
        state.velocity = velocity
        state.surface = .airborne
    }

    /// Flying — free directional movement, no gravity, clamped to screen
    public static func applyFly(_ state: inout PetPhysicsState, direction: CGVector,
                         speed: CGFloat, dt: CGFloat, surfaces: ScreenSurfaces) {
    ...
    public static func applyHop(_ state: inout PetPhysicsState, direction: HorizontalDirection,
    ...
    public static func applyBounce(_ state: inout PetPhysicsState, jumpVelocity: CGFloat = -200) {
        state.velocity.dy = jumpVelocity
        state.surface = .airborne
    }
