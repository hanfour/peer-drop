...
public enum SpriteDirection: String, CaseIterable, Hashable {
    case south       = "south"
...
public struct SpriteRequest: Hashable {
    public let species: SpeciesID
    public let stage: PetLevel
    public let direction: SpriteDirection
    public init(species: SpeciesID, stage: PetLevel, direction: SpriteDirection) {
        self.species = species; self.stage = stage; self.direction = direction
    }
}
