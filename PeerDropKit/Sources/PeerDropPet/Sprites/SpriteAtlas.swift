...
public struct SpriteAtlas: Equatable {
    public let atlasVersion: Int
    public let frameSize: FrameSize
    public let frames: [String: Rect]
...
public enum SpriteAtlasError: Error {
...
extension SpriteAtlas {
    ...
    public static func parse(zipURL: URL) throws -> SpriteAtlas? {
        let archive: Archive
        do {
    ...
    public static func parse(archive: Archive) throws -> SpriteAtlas? {
    ...
    public func rect(for path: String) -> Rect? {
        frames[path]
    }
}
