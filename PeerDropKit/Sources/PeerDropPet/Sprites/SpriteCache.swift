...
public final class SpriteCache {
    ...
    public init(countLimit: Int = 30) {
        cache.countLimit = countLimit
    }

    public func image(for key: SpriteRequest) -> CGImage? {
    ...
    public func setImage(_ image: CGImage, for key: SpriteRequest) {
    ...
    public var statistics: (hits: Int, misses: Int) {
        lock.lock()
        defer { lock.unlock() }
