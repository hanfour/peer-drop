...
public enum Rarity: Int, CaseIterable {
    case common = 0
    case rare = 1
    case epic = 2
    case legendary = 3
...
public enum VariantTrait: Hashable {
...
public struct VariantSpec: Hashable {
    public let id: String
    public let traits: Set<VariantTrait>

    public init(_ id: String, traits: Set<VariantTrait> = []) {
        self.id = id
        self.traits = traits
    }
    ...
    public var accessoryAssetName: String? {
        for t in traits {
    ...
    public var uniqueIdle: (key: String, after: TimeInterval)? {
        for t in traits {
...
public enum SpeciesCatalog {
    ...
    public static let allIDs: [SpeciesID] = families.keys.sorted().flatMap { family -> [SpeciesID] in
    ...
    public static func familyDefault(for family: String) -> SpeciesID? {
    ...
    public static func resolve(_ id: SpeciesID) -> SpeciesID? {
    ...
    public static func variants(for family: String) -> [String] {
    ...
    public static func variantSpecs(for family: String) -> [VariantSpec] {
    ...
    public static func traits(for speciesID: SpeciesID) -> Set<VariantTrait> {
    ...
    public static func stagesShipped(for family: String) -> Set<PetLevel> {
    ...
    public static func isSingleAssetFamily(_ family: String) -> Bool {
