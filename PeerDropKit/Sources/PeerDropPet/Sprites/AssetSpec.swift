...
public enum AssetSpec {
    ...
    public static let canonicalCanvas: CGSize = CGSize(width: 68, height: 68)
    ...
    public static let directions = 8
    ...
    public static let actionHeuristicWalkMinFrames = 6
    ...
    public static let normalizedSchemaVersion = "3.0"
    public static let rawPixelLabSchemaVersion = "2.0"
}
