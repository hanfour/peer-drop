...
@MainActor
public class PetAnimationController: ObservableObject {
    ...
    public private(set) var fps: Int = 6
    public private(set) var totalFrames: Int = 2
    ...
    public var frameRate: TimeInterval { 1.0 / Double(max(fps, 1)) }
    ...
    public var isAnimating: Bool { !paused }
    ...
    public func setAction(_ action: PetAction, frameCount: Int, fps: Int) {
    ...
    public func setAction(_ action: PetAction, frameCount: Int) {
    ...
    public func pause()  { stopAnimation() }
    public func resume() { startAnimation() }
}
