...
public struct ColorPalette: Equatable {
    public let outline: Color    // slot 1
    public let primary: Color    // slot 2
    public let secondary: Color  // slot 3
    public let highlight: Color  // slot 4
    public let accent: Color     // slot 5
    public let pattern: Color    // slot 6

    public init(outline: Color, primary: Color, secondary: Color, highlight: Color, accent: Color, pattern: Color) {
        self.outline = outline; self.primary = primary; self.secondary = secondary
        self.highlight = highlight; self.accent = accent; self.pattern = pattern
    }
...
public enum PetPalettes {
    public static let all: [ColorPalette] = [
    ...
    public static let egg = ColorPalette(
    ...
    public static func palette(for genome: PetGenome) -> ColorPalette {
